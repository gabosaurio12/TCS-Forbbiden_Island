...
social_media int IDENTITY(1,1) primary key,
player_id int,
social_link nvarchar(50),
CONSTRAINT FK_player_socialmedia FOREIGN KEY (player_id) REFERENCES player(player_id)
)
...
card_type nvarchar(10) primary key
)
...
CONSTRAINT FK_match_players_match FOREIGN KEY (match_id) REFERENCES matches(match_id),
CONSTRAINT FK_players_player FOREIGN KEY (player_id) REFERENCES player(player_id)
)
