...
namespace Forbbiden.Client.GameManager {
    ...
    public interface IGameManager {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGameManager/KickPlayer", ReplyAction="http://tempuri.org/IGameManager/KickPlayerResponse")]
        System.Threading.Tasks.Task KickPlayerAsync(string matchId, string hostUsername, string targetUsername);
    }
    ...
    public partial class GameManagerClient : System.ServiceModel.DuplexClientBase<Forbbiden.Client.GameManager.IGameManager>, Forbbiden.Client.GameManager.IGameManager {
        ...
        public void KickPlayer(string matchId, string hostUsername, string targetUsername) {
            base.Channel.KickPlayer(matchId, hostUsername, targetUsername);
        }
        
        public System.Threading.Tasks.Task KickPlayerAsync(string matchId, string hostUsername, string targetUsername) {
            return base.Channel.KickPlayerAsync(matchId, hostUsername, targetUsername);
        }
    }
}
