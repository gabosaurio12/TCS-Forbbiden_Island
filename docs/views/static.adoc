...
.Modelo de dominio
image:../images/diagrams/classes/domain.png[Modelo de dominio, width=600, align=left]
...
.Diagrama de clases
image:../images/class.png[Diagrama de clases, width=900, align=left]
...
.Diagrama de interacción
image:../images/interaction.png[Diagrama de interacción, width=900, align=center]