...
image::screenshots/avance13-10/login-es.png[Inicio de sesión como servicio en español, width=600, align=left]
.Inicio de sesión en inglés
image::screenshots/avance13-10/login-en.png[Inicio de sesión como servicio en inglés, width=600, align=left]
...
image::screenshots/avance13-10/signup-es.png[Registro de usuario como servicio en español, width=600, align=left]
.Registro de usuario en inglés
image::screenshots/avance13-10/signup-en.png[Registro de usuario como servicio en inglés, width=600, align=left]
...
image::screenshots/avance13-10/profile-es.png[Página de perfil como servicio en español, width=600, align=left]
.Página de perfil en inglés
image::screenshots/avance13-10/profile-en.png[Página de perfil como servicio en inglés, width=600, align=left]
.Subir avatar en español
image::screenshots/avance13-10/profile_select_avatar-es.png[Subir avatar en inglés, width=600, align=left]
.Subir avatar en inglés
image::screenshots/avance13-10/profile_select_avatar-en.png[Subir avatar en inglés, width=600, align=left]
...
image::screenshots/avance13-10/mainpage-es.png[Menú principal en español, width=600, align=left]
.Menú principal en inglés
image::screenshots/avance13-10/mainpage-en.png[Menú principal en inglés, width=600, align=left]
.Menú principal loggeado en español
image::screenshots/avance13-10/mainpage-logged-es.png[Menú principal en español, width=600, align=left]
.Menú pirncipal loggeado en inglés
image::screenshots/avance13-10/mainpage-logged-en.png[Menú principal en español, width=600, align=left]
...
image::screenshots/avance13-10/newgame-es.png[Nuevo juego en español, width=600, align=left]
.Nuevo juego en inglés
image::screenshots/avance13-10/newgame-en.png[Nuevo juego en inglés, width=600, align=left]
...
.Pruebas
image::screenshots/avance13-10/tests.png[Pruebas, width=600, align=left]
